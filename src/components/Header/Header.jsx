      ...
      <>
        ...
        <div className={styles.mobileHeader}>
          <div onClick={() => setIsMobileMenu(!isMobileMenu)}>
            {!isMobileMenu ? (
              <AiOutlineMenu className={styles.icon} size={25} color="#042432" />
            ) : (
              <IoCloseSharp className={styles.icon} size={25} color="#042432" />
            )}
          </div>
          {isMobileMenu && (
            <SlideMenu
          ...
          <a href="tel:1533-8848">
            <IoCall className={styles.icon} size={25} color="#042432" />
          </a>
        </div>
