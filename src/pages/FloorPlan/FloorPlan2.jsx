  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="84타입의평면 안내 페이지는원종 휴먼빌 클라츠의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요."
        />
        <meta
          name="keywords"
          content="원종 휴먼빌 클라츠, 부천 원종 휴먼빌 , 원종 휴먼빌 클라츠모델하우스"
        />
        <link rel="canonical" href="https://www.marvelpartners.co.kr/FloorPlan/59B" />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="원종 휴먼빌 클라츠 - 84타입 평면도"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.marvelpartners.co.kr/FloorPlan/59B"
        />
        ...
        <script type="application/ld+json">
          {`
				...
				"@type": "WebPage",
				"name": "원종 휴먼빌 클라츠 - 84타입 평면도",
				"description": "84타입의평면 안내 페이지는원종 휴먼빌 클라츠의 각 아파트 평면도를 제공합니다. 고객들이 아파트의 구조를 정확히 이해하고, 자신의 생활 스타일에 맞는 평형을 선택할 수 있도록 돕습니다. 다양한 평면 설계를 확인하고 자신에게 맞는 최적의 공간을 찾아보세요.",
				"url": "https://www.marvelpartners.co.kr/FloorPlan/59B"
						}
						`}
        </script>
      </Helmet>
      ...
      <p className={styles.screenReaderOnly}>
        84타입의평면 안내 페이지는원종 휴먼빌 클라츠의 각 아파트 평면도를
