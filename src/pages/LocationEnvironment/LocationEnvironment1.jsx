...
const LocationSection = [
  {
    img: section2Image1,
    titleText:
      "확정된 개발호재로<br />부천을 더 새롭게 살수록 높아지는 미래가치",
    contentText:
  ...
  },
  {
    ...
    contentText:
      "이마트, 하나로마트 , 오정농수산물 시장과<br /> 부천병원,회덕초등학교 등 편리한 인프라",
  },
  {
    img: section2Image5,
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="원종 휴먼빌 클라츠, 부천 휴먼빌 클라츠, 원종 휴먼빌 클라츠모델하우스"
        />
        ...
        <meta
          property="og:url"
          content="https://www.abcya4.com/LocationEnvironment/intro"
        />
      ...
      <p className={styles.screenReaderOnly}>
        원종 휴먼빌 클라츠의 입지 안내 페이지는 이 단지의 위치와 주변 인프라에
