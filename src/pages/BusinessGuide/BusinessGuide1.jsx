...
const projectData = [
  { label: "사업명", value: "원종 휴먼빌 클라츠" },
  { label: "사업위치", value: "경기도 부천시 오정구 원종동 101-2 일원" },
  { label: "대지면적", value: "10,557.00㎡" },
  { label: "건축규모", value: "지하 2층 ~ 지상 15층" },
  { label: "세대수", value: " 공동주택 255세대 (전용 46㎡ / 47㎡ / 59㎡A,B,C)" },
];
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>원종 휴먼빌 클라츠 - 사업안내</title>
        <meta
          name="description"
          content="원종 휴먼빌 클라츠은 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다."
        />
        <meta
          name="keywords"
        ...
        <meta property="og:title" content="원종 휴먼빌 클라츠 - 사업안내" />
        <meta
          ...
          {`
		{
			...
			"@type": "WebPage",
			"name": "원종 휴먼빌 클라츠 - 사업안내",
			"description": "원종 휴먼빌 클라츠은 혁신적인 주거 환경을 제공하는 새로운 아파트 단지입니다. 이 페이지에서는 프로젝트의 전체적인 개요와 개발 계획을 상세히 소개합니다. 사업의 목적, 주요 설계 및 특징, 그리고 주변 환경을 포함한 다양한 정보를 통해 입주자들에게 더 나은 선택을 할 수 있도록 돕습니다.",
      ...
      <p className={styles.screenReaderOnly}>
        원종 휴먼빌 클라츠은 혁신적인 주거 환경을 제공하는 새로운 아파트
