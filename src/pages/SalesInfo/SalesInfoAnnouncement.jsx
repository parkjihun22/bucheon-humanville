  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        {/* SEO 최적화를 위한 메타 태그 */}
        <title>원종 휴먼빌 클라츠 - 모집공고안내</title>
        <meta
          name="description"
          content="원종 휴먼빌 클라츠의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요."
        />
        <meta
          name="keywords"
          content="원종 휴먼빌 클라츠, 휴먼빌 클라츠, 원종 휴먼빌 클라츠모델하우스"
        />
        <link
          rel="canonical"
          href="https://www.abcya4.com/SalesInfo/announcement"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta property="og:title" content="원종 휴먼빌 클라츠 - 모집공고안내" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.abcya4.com/SalesInfo/announcement"
        />
        ...
        <script type="application/ld+json">
          {`
             ...
             "@type": "WebPage",
             "name": "원종 휴먼빌 클라츠 - 모집공고안내",
             "description": "원종 휴먼빌 클라츠의 모집 공고는 분양 전 단계에서 중요한 안내문입니다. 이 페이지에서는 모집 공고에 포함된 중요한 날짜, 자격 조건, 필요한 서류 등을 명확하게 안내하여 예비 청약자들이 혼동 없이 청약을 준비할 수 있도록 지원합니다. 모집 공고를 통해 필수 정보들을 빠짐없이 체크하세요.",
      ...
      <p className={styles.screenReaderOnly}>
        원종 휴먼빌 클라츠의 모집 공고는 분양 전 단계에서 중요한 안내문입니다.
