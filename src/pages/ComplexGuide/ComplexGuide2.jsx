  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.abcya4.com/ComplexGuide/detailintro"
        />

        {/* Open Graph - 소셜 미디어 공유 최적화 */}
        <meta
          property="og:title"
          content="원종 휴먼빌 클라츠 - 호수배치도"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.abcya4.com/ComplexGuide/detailintro"
        />
